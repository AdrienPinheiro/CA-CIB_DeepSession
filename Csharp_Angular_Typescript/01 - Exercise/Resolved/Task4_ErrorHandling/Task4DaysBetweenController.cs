...
namespace TasksSolution.Task4;

[ApiController]
[Route("api/solution/task4")]
public class Task4DaysBetweenController : ControllerBase
{
    private readonly ILogger<Task4DaysBetweenController> _logger;

    public Task4DaysBetweenController(ILogger<Task4DaysBetweenController> logger)
    {
        _logger = logger;
    }
